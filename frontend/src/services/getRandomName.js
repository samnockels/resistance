// From Docker, (starting from 0.7.x, generates names from notable scientists and hackers).
...
function getRandomName() {
    return `${left[getRandomInt(left.length)]}-${right[getRandomInt(right.length)]}`
}
